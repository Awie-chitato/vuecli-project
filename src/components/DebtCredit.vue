  ...
  <div class="debt-credit">
    ...
    <div v-if="!showInputForm" class="history-section">
      <div class="table-header">
        ...
        <button @click="showDebtCreditTypeModal = true" class="add-button" style="background-color: #0066cc; color: white; border: none;  border-radius: 5px;">Tambah</button>
      </div>
    ...
    <div v-if="showDebtCreditTypeModal" class="modal">
      <div class="modal-content">
        ...
        <button @click="startNewDebtCredit('hutang')" class="action-button edit" style="background-color: #ffc107; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; margin-right: 15px;">Catatan Hutang</button>
        <button @click="startNewDebtCredit('piutang')" class="action-button delete" style="background-color: #dc3545; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; margin-right: 15px;">Catatan Piutang</button>
